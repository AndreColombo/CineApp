...
export default function CardFilme() {
  ...
  return (
    <>
      <h1 className='m-4 pl-14 text-xl font-bold text-26 dark:text-FF'>Mais Bem Avaliados</h1>
        ...
        {topFilmes.map((filme) => (
          <Link
            ...
            <div className='relative z-10 w-full'>
              <h1 className='mb-2 pl-3 font-bold'>{filme.title}</h1>
              <p className='line-clamp-2 pl-3 pr-3 text-sm text-FF text-opacity-75'>{filme.overview}</p>
              <div className='flex justify-between p-3'>
                <div className='flex items-center space-x-2'>
                  ...
                  <span className='flex-shrink-0 rounded bg-18 p-1 text-sm font-medium uppercase text-FF text-opacity-75'>{filme.original_language}</span>
                </div>
